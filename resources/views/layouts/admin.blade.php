  ...
  <header class="sticky-top bg-white border-bottom shadow-sm">
    <nav class="container d-flex align-items-center justify-content-between py-2">
      ...
      <div class="d-flex gap-2">
        ...
        <div class="dropdown">
          <button class="btn nav-button dropdown-toggle text-dark" type="button" id="dropdownThongTin" data-bs-toggle="dropdown" aria-expanded="false" >
            Quản lý thông tin
          </button>
        ...
        <div class="dropdown">
          <button class="btn nav-button dropdown-toggle text-dark" type="button" id="dropdownKhoaHoc" data-bs-toggle="dropdown" aria-expanded="false">
            Quản lý khóa học
          </button>
      ...
      <!-- Logout Button -->
      <div>
        <a href="#" class="btn btn-outline-secondary d-flex align-items-center gap-2 btn-logout">

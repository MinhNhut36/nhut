  ...
  <header class="sticky-top bg-white border-bottom shadow-sm">
    <nav class="container d-flex align-items-center justify-content-between py-2">
      ...
      <div class="d-flex gap-2">
        <a href="{{route('student.home')}}" id="btn-thongtin"  class="btn nav-button active text-dark">Thông tin sinh viên</a>
        <a href="" id="btn-khoahoc"  class="btn nav-button text-dark">Khóa Học</a>
        <a href="" id="btn-danghoc"  class="btn nav-button text-dark">Đang học</a>
      </div>
      <div>

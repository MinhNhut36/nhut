    ...
    <div class="container" style="max-width: 80%;">
        <div class="filter-btn-group">
            <a href="{{ route('teacher.coursesopening') }}"
                class="filter-btn {{ request()->routeIs('teacher.coursesopening') ? 'active' : '' }}" id="btn-studying">Đang
                mở lớp</a>
            <a href="{{ route('teacher.coursescompleted') }}"
                class="filter-btn {{ request()->routeIs('teacher.coursescompleted') ? 'active' : '' }}" id="btn-completed">Đã
                hoàn thành</a>
        </div>
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled small text-dark">
                                ...
                                <li class="mb-2 d-flex justify-content-between">
                                    ...
                                    <span
                                        class="fw-semibold text-dark">{{ $countStudents[$MyCourse->course_id] ?? 0 }}</span>
                                </li>
                                <li class="mb-2 d-flex justify-content-between">
                                    <span class="fw-semibold">
                                ...
                                <li class="d-flex justify-content-between">
                                    ...
                                    <span class="{{ $MyCourse->course->status->BagdeClass() }}">
                                        {{ $MyCourse->course->status->value }}
                                    </span>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="col-12">
                    <div class="empty-state">
                        <div class="empty-state-icon">
                            @if (request()->routeIs('teacher.coursescompleted'))

...
<head>
    ...
    <title>ĐĂNG NHẬP CHO GIÁO VIÊN</title>
    <!-- Bootstrap 5 CSS -->
                        ...
                        <div class="col-md-6 right-side">
                            ...
                            <div class="forms-container" style="height: 300px;">
                                ...
                                <div class="form-wrapper teacher-form">
                                    ...
                                    @if ($errors->has('TeacherLoginFail'))
                                        <div class="alert alert-danger">
                                            {{ $errors->first('TeacherLoginFail') }}
                                        </div>
                                    @endif
                                    <form action="{{ route('teacher.authlogin') }}" method="POST">
                                        @csrf
                                        <div class="mb-3">
                                    ...
                                    <div class="switch-role mt-3">
                                        <a href="{{route('login')}}">Sinh Viên Đăng Nhập</a>
                                    </div>
                                </div>
                            </div>
                        </div>
